...
function ListTags()
{
	...
	{
		if($tag!="0" && !empty($tag))
		$output=$output.'<span class="tagcloud" style="font-size:'.($value+10<20?$value+10:19).'px;font-weight:'.($value+500).'">
						 <a href="'.$ScriptUrl.'?action=tags&amp;tag='.$tag.'"><span style="white-space:nowrap">'.$tag.'</span></a></span>';
	}
